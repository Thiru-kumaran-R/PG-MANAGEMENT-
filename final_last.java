                ...
                switch (choice) {
                    ...
                    case 5:
                        ...
                        if (!phone.matches("\\d{10}")) {
                            System.out.println("Hint: Enter a 10 digit phone number.");
                            break;
                        }
                        System.out.print("Enter PAN Number: ");
                        String pan = sc.nextLine().toUpperCase();
                        if (!pan.matches("[A-Z]{5}[0-9]{4}[A-Z]")) {
                            System.out.println("Hint: Use PAN format ABCDE1234F.");
                            break;
                        }
                        System.out.print("Enter Aadhaar Number: ");
                        String aadhaar = sc.nextLine();
                        if (!aadhaar.matches("\\d{12}")) {
                            System.out.println("Hint: Enter a 12 digit Aadhaar number.");
                            break;
                        }
